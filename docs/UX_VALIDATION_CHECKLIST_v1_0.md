...
| 2 | Does an IA entry exist for this page? | Add it to site architecture (Stage 3) |
...
- [ ] **Page exists in IA:** Is this page documented in SITE_ARCHITECTURE?
...
- [ ] **Journey still accurate?** Update UX_STAGES doc if journey changed
- [ ] **IA still accurate?** Update SITE_ARCHITECTURE if structure changed
- [ ] **Wireframe still accurate?** Update wireframe if layout changed
- [ ] **New patterns?** Add to style guide if new components created
...
|---------|------|---------|
| 1.0 | Jan 24, 2026 | Initial checklist |
