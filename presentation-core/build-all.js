...
const templates = [
  {
    ...
    dir: path.join(__dirname, '..', 'presentation')
  },
  {
    name: 'Teaching Infrastructure Pitch',
    dir: path.join(__dirname, '..', 'pitch-a')
  },
  {
    name: 'How luminAIT Scales Teaching',
    dir: path.join(__dirname, '..', 'pitch-b')
  }
];
...
templates.forEach((template, index) => {
  ...
  try {
    ...
    execSync('node ../presentation-core/generate_pdf.js', { stdio: 'inherit' });
